...
TEST_DIR = 'E:/Python/signatue_recog/data/test/'
...
COLS = 160
CHANNELS = 3
TRAIN_DIR = "E:/Python/signatue_recog/data/train/"
...
submission.to_csv('E:/Python/signatue_recog/signatureResults.csv', index=False)